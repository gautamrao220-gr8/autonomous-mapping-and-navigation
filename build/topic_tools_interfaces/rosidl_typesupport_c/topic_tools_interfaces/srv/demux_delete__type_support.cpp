...
static const _DemuxDelete_Request_type_support_symbol_names_t _DemuxDelete_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, topic_tools_interfaces, srv, DemuxDelete_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, topic_tools_interfaces, srv, DemuxDelete_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, topic_tools_interfaces, srv, DemuxDelete_Request)() {
  return &::topic_tools_interfaces::srv::rosidl_typesupport_c::DemuxDelete_Request_message_type_support_handle;
}
...
static const _DemuxDelete_Response_type_support_symbol_names_t _DemuxDelete_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, topic_tools_interfaces, srv, DemuxDelete_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, topic_tools_interfaces, srv, DemuxDelete_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, topic_tools_interfaces, srv, DemuxDelete_Response)() {
  return &::topic_tools_interfaces::srv::rosidl_typesupport_c::DemuxDelete_Response_message_type_support_handle;
}
...
static const _DemuxDelete_Event_type_support_symbol_names_t _DemuxDelete_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, topic_tools_interfaces, srv, DemuxDelete_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, topic_tools_interfaces, srv, DemuxDelete_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, topic_tools_interfaces, srv, DemuxDelete_Event)() {
  return &::topic_tools_interfaces::srv::rosidl_typesupport_c::DemuxDelete_Event_message_type_support_handle;
}
...
static const _DemuxDelete_type_support_symbol_names_t _DemuxDelete_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, topic_tools_interfaces, srv, DemuxDelete)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, topic_tools_interfaces, srv, DemuxDelete)),
  }
};
...
static const rosidl_service_type_support_t DemuxDelete_service_type_support_handle = {
  ...
  &DemuxDelete_Request_message_type_support_handle,
  &DemuxDelete_Response_message_type_support_handle,
  &DemuxDelete_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, topic_tools_interfaces, srv, DemuxDelete)() {
  return &::topic_tools_interfaces::srv::rosidl_typesupport_c::DemuxDelete_service_type_support_handle;
}
