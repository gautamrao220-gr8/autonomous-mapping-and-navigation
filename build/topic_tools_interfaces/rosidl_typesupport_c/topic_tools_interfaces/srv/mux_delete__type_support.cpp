...
static const _MuxDelete_Event_type_support_symbol_names_t _MuxDelete_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, topic_tools_interfaces, srv, MuxDelete_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, topic_tools_interfaces, srv, MuxDelete_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, topic_tools_interfaces, srv, MuxDelete_Event)() {
  return &::topic_tools_interfaces::srv::rosidl_typesupport_c::MuxDelete_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t MuxDelete_service_type_support_handle = {
  ...
  &MuxDelete_Request_message_type_support_handle,
  &MuxDelete_Response_message_type_support_handle,
  &MuxDelete_Event_message_type_support_handle,
