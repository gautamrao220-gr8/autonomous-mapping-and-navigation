...
inline std::string to_yaml(const MuxSelect_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use topic_tools_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const topic_tools_interfaces::srv::MuxSelect_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  topic_tools_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use topic_tools_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const topic_tools_interfaces::srv::MuxSelect_Event & msg)
{
  return topic_tools_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<topic_tools_interfaces::srv::MuxSelect_Event>()
{
  return "topic_tools_interfaces::srv::MuxSelect_Event";
}

template<>
inline const char * name<topic_tools_interfaces::srv::MuxSelect_Event>()
{
  return "topic_tools_interfaces/srv/MuxSelect_Event";
}

template<>
struct has_fixed_size<topic_tools_interfaces::srv::MuxSelect_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<topic_tools_interfaces::srv::MuxSelect_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<topic_tools_interfaces::srv::MuxSelect_Request>::value && has_bounded_size<topic_tools_interfaces::srv::MuxSelect_Response>::value> {};

template<>
struct is_message<topic_tools_interfaces::srv::MuxSelect_Event>
  : std::true_type {};
