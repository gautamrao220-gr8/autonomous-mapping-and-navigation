...
enum
{
  topic_tools_interfaces__srv__MuxSelect_Event__request__MAX_SIZE = 1
};
// response
enum
{
  topic_tools_interfaces__srv__MuxSelect_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MuxSelect in the package topic_tools_interfaces.
typedef struct topic_tools_interfaces__srv__MuxSelect_Event
{
  service_msgs__msg__ServiceEventInfo info;
  topic_tools_interfaces__srv__MuxSelect_Request__Sequence request;
  topic_tools_interfaces__srv__MuxSelect_Response__Sequence response;
} topic_tools_interfaces__srv__MuxSelect_Event;

// Struct for a sequence of topic_tools_interfaces__srv__MuxSelect_Event.
typedef struct topic_tools_interfaces__srv__MuxSelect_Event__Sequence
{
