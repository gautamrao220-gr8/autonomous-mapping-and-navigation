...
enum
{
  topic_tools_interfaces__srv__MuxAdd_Event__request__MAX_SIZE = 1
};
// response
enum
{
  topic_tools_interfaces__srv__MuxAdd_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MuxAdd in the package topic_tools_interfaces.
typedef struct topic_tools_interfaces__srv__MuxAdd_Event
{
  service_msgs__msg__ServiceEventInfo info;
  topic_tools_interfaces__srv__MuxAdd_Request__Sequence request;
  topic_tools_interfaces__srv__MuxAdd_Response__Sequence response;
} topic_tools_interfaces__srv__MuxAdd_Event;

// Struct for a sequence of topic_tools_interfaces__srv__MuxAdd_Event.
typedef struct topic_tools_interfaces__srv__MuxAdd_Event__Sequence
{
