...
topic_tools_interfaces__srv__MuxList_Request__create(void)
{
...
topic_tools_interfaces__srv__MuxList_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
topic_tools_interfaces__srv__MuxList_Event__init(topic_tools_interfaces__srv__MuxList_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    topic_tools_interfaces__srv__MuxList_Event__fini(msg);
    return false;
  }
  // request
  if (!topic_tools_interfaces__srv__MuxList_Request__Sequence__init(&msg->request, 0)) {
    topic_tools_interfaces__srv__MuxList_Event__fini(msg);
    return false;
  }
  // response
  if (!topic_tools_interfaces__srv__MuxList_Response__Sequence__init(&msg->response, 0)) {
    topic_tools_interfaces__srv__MuxList_Event__fini(msg);
    return false;
  }
  return true;
...
void
topic_tools_interfaces__srv__MuxList_Event__fini(topic_tools_interfaces__srv__MuxList_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  topic_tools_interfaces__srv__MuxList_Request__Sequence__fini(&msg->request);
  // response
  topic_tools_interfaces__srv__MuxList_Response__Sequence__fini(&msg->response);
}

bool
topic_tools_interfaces__srv__MuxList_Event__are_equal(const topic_tools_interfaces__srv__MuxList_Event * lhs, const topic_tools_interfaces__srv__MuxList_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!topic_tools_interfaces__srv__MuxList_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!topic_tools_interfaces__srv__MuxList_Response__Sequence__are_equal(
...
bool
topic_tools_interfaces__srv__MuxList_Event__copy(
  const topic_tools_interfaces__srv__MuxList_Event * input,
  topic_tools_interfaces__srv__MuxList_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!topic_tools_interfaces__srv__MuxList_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!topic_tools_interfaces__srv__MuxList_Response__Sequence__copy(
...
topic_tools_interfaces__srv__MuxList_Event *
topic_tools_interfaces__srv__MuxList_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  topic_tools_interfaces__srv__MuxList_Event * msg = (topic_tools_interfaces__srv__MuxList_Event *)allocator.allocate(sizeof(topic_tools_interfaces__srv__MuxList_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(topic_tools_interfaces__srv__MuxList_Event));
  bool success = topic_tools_interfaces__srv__MuxList_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
topic_tools_interfaces__srv__MuxList_Event__destroy(topic_tools_interfaces__srv__MuxList_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    topic_tools_interfaces__srv__MuxList_Event__fini(msg);
...
bool
topic_tools_interfaces__srv__MuxList_Event__Sequence__init(topic_tools_interfaces__srv__MuxList_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  topic_tools_interfaces__srv__MuxList_Event * data = NULL;

  if (size) {
    data = (topic_tools_interfaces__srv__MuxList_Event *)allocator.zero_allocate(size, sizeof(topic_tools_interfaces__srv__MuxList_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = topic_tools_interfaces__srv__MuxList_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        topic_tools_interfaces__srv__MuxList_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
topic_tools_interfaces__srv__MuxList_Event__Sequence__fini(topic_tools_interfaces__srv__MuxList_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      topic_tools_interfaces__srv__MuxList_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
topic_tools_interfaces__srv__MuxList_Event__Sequence *
topic_tools_interfaces__srv__MuxList_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  topic_tools_interfaces__srv__MuxList_Event__Sequence * array = (topic_tools_interfaces__srv__MuxList_Event__Sequence *)allocator.allocate(sizeof(topic_tools_interfaces__srv__MuxList_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = topic_tools_interfaces__srv__MuxList_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
topic_tools_interfaces__srv__MuxList_Event__Sequence__destroy(topic_tools_interfaces__srv__MuxList_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    topic_tools_interfaces__srv__MuxList_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
topic_tools_interfaces__srv__MuxList_Event__Sequence__are_equal(const topic_tools_interfaces__srv__MuxList_Event__Sequence * lhs, const topic_tools_interfaces__srv__MuxList_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!topic_tools_interfaces__srv__MuxList_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
topic_tools_interfaces__srv__MuxList_Event__Sequence__copy(
  const topic_tools_interfaces__srv__MuxList_Event__Sequence * input,
  topic_tools_interfaces__srv__MuxList_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(topic_tools_interfaces__srv__MuxList_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    topic_tools_interfaces__srv__MuxList_Event * data =
      (topic_tools_interfaces__srv__MuxList_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!topic_tools_interfaces__srv__MuxList_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          topic_tools_interfaces__srv__MuxList_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!topic_tools_interfaces__srv__MuxList_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
